...
def main():
    ...
    #for i in range(1000)       #(Por el tamaño del archivo es demasiado demorado al momento de compilar,
    for i in range(len(datos)): #pero también se puede probar con datos como por ej 1000)
